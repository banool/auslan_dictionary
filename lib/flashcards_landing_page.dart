...
final FlashcardsConfig auslanFlashcardsConfig = FlashcardsConfig(
  ...
  buildRegionInfo: (context, resolved, shouldUseHorizontalDisplay, revealed) {
    final regionsText = revealed
        ? (resolved.subEntry as MySubEntry).getRegionsString()
        : "";
  ...
  buildExtraAppBarActions:
      (
        ...
        getAuslanSignbankLaunchAppBarActionWidget(
          context,
          word,
          (resolved.subEntry as MySubEntry).index,
          enabled: revealed,
        ),
      ],
);
...
class MyFlashcardsLandingPageController
  ...
  Widget buildHelpPage(BuildContext context) {
    return getFlashcardsHelpPageEn(
      subjectNoun: "word",
      extraItems: const {
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        DictLibLocalizations.of(ctx)!.regionSheetTitle,
                        style: tt.titleLarge,
                      ),
                      ...
                      sectionLabel(
                        DictLibLocalizations.of(ctx)!.regionSheetDialects
                            .toUpperCase(),
                      ),
                      Wrap(
                        spacing: 8,
